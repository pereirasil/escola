      ...
      <Card title="Notificações">
        {loading ? (
          ...
          <ul style={{ listStyle: 'none', padding: 0 }}>
            {lista.map((n) => (
              <li key={n.id} style={{ padding: '1rem', marginBottom: '0.5rem', background: '#f5f5f5', borderRadius: '8px', borderLeft: '4px solid #646cff' }}>
                <strong>{n.title}</strong>
                {n.message && <p style={{ margin: '0.5rem 0 0', color: '#666' }}>{n.message}</p>}
